...
def main():
    ...
    # Create StringVar to hold user input for location and number of days
    location_selected = StringVar()
    num_days_selected = IntVar()

    # Configure the styles for the widgets using an external function
    configure_styles()
    ...
    def save_inputs():
        ...
        # Call the forecast_finder function to get the forecast
